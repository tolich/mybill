...
class Acl {
	...
	*/
	...
	protected $rn = array(
		'all'=>array(
			'admin'=>'Открытый доступ',
			'auth'=>'Открытый доступ',
			'modules'=>'Открытый доступ',
			'nas'=>'Открытый доступ',
			'payments'=>'Открытый доступ',
			'pools'=>'Открытый доступ',
			'users'=>'Открытый доступ',
			'reports'=>'Открытый доступ',
			'sessions'=>'Открытый доступ',
			'settings'=>'Открытый доступ',
			'sluices'=>'Открытый доступ',
			'tariffs'=>'Открытый доступ',
			'tasks'=>'Открытый доступ',
			'zones'=>'Открытый доступ',
		),
		'view'=>array(
